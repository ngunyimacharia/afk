...
2. **Prepare the worktree first**: Before reading beyond the provided ticket
   context or making implementation changes, derive or consume AFK worktree
   context and prepare the persistent local worktree.
